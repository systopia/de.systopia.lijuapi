 ...
 * (GenCodeChecksum:76581e348f0c6e0ec3bf696e6ffb1386)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => CRM_Lijuapi_ExtensionUtil::ts('Unique LijuErrorHandler ID'),
          'required' => TRUE,
        ...
        'contact_id' => [
          'name' => 'contact_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Lijuapi_ExtensionUtil::ts('FK to Contact'),
        ...
        'email' => [
          ...
          'title' => CRM_Lijuapi_ExtensionUtil::ts('Email'),
          'description' => CRM_Lijuapi_ExtensionUtil::ts('Email that is to be changed'),
          'required' => TRUE,
          'maxlength' => 256,
        ...
        'email_id' => [
          'name' => 'email_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Lijuapi_ExtensionUtil::ts('FK to CiviCRM-Email'),
        ...
        'is_consumed' => [
          ...
          'description' => CRM_Lijuapi_ExtensionUtil::ts('True means the API call is succesfull executed'),
          'required' => TRUE,
        ...
        'landesverband' => [
          'name' => 'landesverband',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Lijuapi_ExtensionUtil::ts('Landesverband'),
          'description' => CRM_Lijuapi_ExtensionUtil::ts('Landesverband Abbrevation'),
          'required' => TRUE,
          'maxlength' => 4,
        ...
        'group_id' => [
          'name' => 'group_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => CRM_Lijuapi_ExtensionUtil::ts('FK to CiviCRM-GroupID'),
        ...
        'timestamp' => [
          ...
          'title' => CRM_Lijuapi_ExtensionUtil::ts('Timestamp'),
          'description' => CRM_Lijuapi_ExtensionUtil::ts('Date the Change was attempted'),
          'required' => TRUE,
